function App() {
    ...
    const display = (symbol) =>{
        ...
        if(expression[expression.leght-1] == "="){
            if(/[1-9.]/.test(symbol)){
    ...
    return (
        <div className="container">
            <div className="gird">
                <div oneClick={display} className="dis">
                    <input type="text" value={expression} placeholder="0" disabled />
                    <div className="total">{answer}</div>
                </div>
                <div onClick={allClear} className="padButton AC">AC</div>
                <div onClick={()=>display("/")} className="padButton division">/</div>
                <div onClick={()=>display("x")} className="padButton multiply">x</div>
                ...
                <div onClick={()=>display("+")} className="padButton sum">+</div>
                ...
                <div onClick={calulate} className="padButton equal">=</div>
